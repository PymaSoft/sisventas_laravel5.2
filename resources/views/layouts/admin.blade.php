...
<head>
    ...
    <title>ADVentas | www.pymasoft.com</title>
...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs">Pedro Jose Cruz</span>
                            </a>
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        http://pyma.comuf.com - Desarrollando Software
                                        <small>pedroincora@gmail.com/</small>
                                    </p>
                                </li>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015-2020 <a href="http://pyma.comuf.com">Pymasoft</a>.</strong> All rights reserved.
    </footer>
